...
#define _INTERVAL_SERVO   50 // servo interval (unit: m)
...
// PID parameters
#define _KP 4.3  // proportional gain
#define _KD 30  // derivative gain
...
void setup() {
  ...
  dist_ema = volt_to_distance(ir_sensor_filtered(13, 0.5, 0));
